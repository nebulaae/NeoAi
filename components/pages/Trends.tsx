  ...
  return (
    <section className="relative h-full w-full overflow-hidden bg-zinc-950">
      ...
      <div className="absolute right-3 bottom-[calc(120px+var(--sa-bottom))] z-20 flex flex-col items-center gap-5">
        ...
        >
          <span className="w-12 h-12 rounded-full flex items-center justify-center bg-[#007AFF] border border-[#007AFF] shadow-[0_0_24px_rgba(0,122,255,0.5)]">
            {generate.isPending ? (
...
export const TrendDetail = ({
  ...
  return (
    ...
    >
      {/* Header */}
      <header className="sticky top-0 z-50 px-6 pb-5 pt-[calc(1.25rem+var(--sa-top))] bg-black/60 backdrop-blur-3xl border-b border-white/5 flex items-center gap-4">
        <button
          onClick={onBack}
