...
export const Generate = () => {
  ...
  if (selected) {
    ...
    const canAttach =
      ...
      selected.input?.includes('video') ||
      selected.input?.includes('audio');
        ...
        <div className="flex flex-col gap-4 p-4 overflow-y-auto">
          ...
          <div>
            ...
            <Textarea
              ...
              className="resize-none min-h-28 bg-secondary/50 border-border/50 text-sm focus-visible:ring-1"
            />
          </div>
