          ...
          <div className="flex flex-col gap-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
            <div className="p-8 rounded-[40px] bg-linear-to-br from-[#007AFF] to-[#0051FF] border border-white/20 shadow-2xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/70 text-[15px] font-medium max-w-[200px] leading-relaxed">
                  {t('partnershipShare')}
                </p>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="p-6 rounded-3xl bg-zinc-900/40 border border-white/5">
                ...
                <p className="text-[32px] font-black text-[#007AFF]">
                  {refStats?.earned ?? 0}
                </p>
              </div>
            </div>
            <div className="flex flex-col gap-4">
              <h3 className="text-[12px] font-black uppercase tracking-[0.15em] text-white/30 px-2">
                {t('partnershipLink')}
              </h3>
              <div className="flex items-center gap-3 p-2 bg-zinc-900/40 border border-white/5 rounded-[24px]">
                ...
                <button
                  ...
                  className="w-14 h-14 rounded-2xl bg-[#007AFF] text-white flex items-center justify-center shadow-[0_0_20px_rgba(0,122,255,0.4)] active:scale-90 transition-all"
                >
