  ...
  return (
    <div className="flex flex-col gap-3 w-full p-4 rounded-2xl bg-white/5 border border-white/10">
      ...
      <div className="flex items-center gap-4">
        <button
          onClick={togglePlay}
          className="w-12 h-12 rounded-full bg-[#007AFF] flex items-center justify-center transition-all active:scale-90 shadow-[0_0_15px_rgba(170,255,0,0.3)]"
        >
          {isPlaying ? (
...
export default function ChatPage() {
  ...
  return (
    <div className="flex flex-col h-dvh max-w-2xl mx-auto w-full text-white overflow-hidden -mb-[calc(80px+max(16px,var(--sa-bottom)))] relative z-40">
      {/* ── Header ── */}
      <header className="sticky top-0 z-50 px-6 pb-4 pt-[calc(1rem+var(--sa-top))] flex items-center gap-4">
        <button
          onClick={() => {
            haptic.light();
            router.back();
        ...
        <div className="flex-1 min-w-0">
          <h1 className="text-[17px] font-bold tracking-tight text-[#007AFF] truncate leading-tight">
            {chatTitle}
          </h1>
          <div className="flex items-center gap-2 mt-0.5">
            {isHistoryLoading ? (
              ...
              <div className="flex items-center gap-1.5 animate-pulse">
                ...
                <span className="text-[11px] text-[#007AFF] font-bold uppercase tracking-wider">
                  {t('generating')}
                </span>
              </div>
            ) : (
            ...
            <button
              ...
              className={cn(
                ...
                isSendDisabled
                  ...
                  : 'bg-[#007AFF] shadow-[0_0_20px_rgba(170,255,0,0.3)]'
              )}
            >
              {generate.isPending ? (
